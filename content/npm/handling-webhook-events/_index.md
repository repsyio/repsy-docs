...
weight = 540
description = "Receive webhook notifications when an npm package is deployed, and verify each request with its HMAC SHA-256 signature."
+++
...
* `package.deployed`: Triggered when a new package is successfully deployed to a Repsy npm repository.
